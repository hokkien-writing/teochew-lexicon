...
|h| ① hi 熙 嘻 犧{牺} 稀 希 烯 頤{颐} 兮 熹 禧 羲   ② hí 喜   ③ hì 戲{戏}   ⑤ hî 畦   ⑥ hĩ 攜{携} 曳 拽 系(~統) 係{系}(關~) 繫{系}(聯~)  |
...
|th| ① tho 胎 推   ② thó 討{讨} 橢{椭} 妥   ③ thò 蛻{蜕} 褪 退   ④ thoh 魄 托(~舉) 託{托}(委~,拜~)   ⑤ thô 萄 桃 鴕{鸵} 陀 馱{驮}   ⑥ thõ 唾   ⑧ tho̍h 駝{驼}  |
...
| |u / uh|
|-|----|
| | ① u 呼 嗚{呜} 烏{乌} 污 捂 迂 盂 圩 竽 于(單~) 吁(長~短嘆)   ② ú 五 雨 禹 宇 羽   ③ ù 塢{坞} 惡{恶}(可~)   ⑤ û 吾 五 娛{娱}   ⑥ ũ 有  |
...
|z| ② zú 乳 愈(~來~好) 癒{愈}(病~)   ⑤ zû 茹 蠕 儒 孺 如 榆 俞 愉 渝   ⑥ zũ 喻 裕 籲{吁}(呼~)  |
|k| ① ku 辜 咕 孤 龜{龟} 駒{驹} 佝   ② kú 古 蠱{蛊} 賈{贾} 韭 久   ③ kù 故 顧{顾} 固 灸 句   ⑥ kũ 舅 具 懼{惧}   ⑦ kū 故 舊{旧}  |
|kh| ① khu 拘 丘 邱 區{区} 軀{躯} 驅{驱} 樞{枢}   ④ khuh 窟   ⑥ khũ 臼  |
|g| ⑤ gû 牛  |
|h| ① hu 夫 敷 膚{肤} 孵 俘 腐 呼 乎 孚   ② hú 俯 釜 腑 府 父 許{许} 栩 缶   ③ hù 赴 副 賦{赋} 傅 付 訃{讣} 咐   ⑤ hû 扶 符 和 瑚 壺{壶} 葫 蝴 狐 弧 芙 胡(~說,~椒) 衚{胡}(~衕) 糊(~塗)   ⑥ hũ 輔{辅} 阜 負{负} 附 婦{妇} 護{护} 互 滬{沪} 酗 煦 瓠 駙{驸}   ⑦ hū 夫 腐  |
...
|th| ④ thiah 拆  |
|l| ⑧ lia̍h 掠  |
|ch| ① chia 遮   ② chiá 姐(翁~) 者 鍺{锗}   ③ chià 蔗 炙   ④ chiah 跡{迹} 脊 隻{只}(一~鳥)   ⑥ chiã 籍 藉(~口,狼~)   ⑦ chiā 謝{谢}   ⑧ chia̍h 食  |
|chh| ① chhia 車{车} 奢 賒{赊}   ② chhiá 且   ④ chhiah 赤  |
|s| ① sia 斜   ② siá 寫{写}   ③ sià 赦 卸 瀉{泻} 舍(房~,阿爺阿~) 捨{舍}(取~)   ④ siah 錫{锡} 削   ⑤ siâ 邪 斜 畬 畲   ⑥ siã 社   ⑦ siā 射 謝{谢}   ⑧ sia̍h 席  |
|j| ② jiá 惹  |
...
|ch| ① chiu 稠 舟 州 洲 周(圓~,~遊) 週{周}(~末,~期)   ② chiú 酒   ③ chiù 咒 皺{皱}   ⑥ chiũ 就  |
...
|g| ⑦ guā 外  |
|h| ① hua 花 華{华}   ④ huah 喝   ⑤ huâ 禾 和 華{华} 划(~算)   ⑥ huã 禍{祸}   ⑧ hua̍h 伐  |
...
|p| ① pue 杯 飛{飞}   ③ pùe 輩{辈} 貝{贝} 背(~誦)   ⑤ pûe 培 賠{赔} 陪   ⑥ pũe 貝{贝} 鋇{钡} 倍 狽{狈} 佩   ⑦ pūe 焙  |
...
|g| ⑧ gu̍eh 鑰{钥} 月  |
|h| ① hue 花 華{华} 化 灰   ② húe 火 伙(~食) 夥{伙}(~伴)   ③ hùe 化 悔 晦 誨{诲} 貨{货} 歲{岁}   ④ hueh 血   ⑤ hûe 和 蛔 回(~頭) 迴{回}(巡~,~轉)   ⑥ hũe 會{会} 燴{烩} 匯{汇}(~款) 彙{汇}(詞~)  |
...
|n| ② núi 餒{馁}  |
|l| ② lúi 蕾 磊 儡 壘{垒} 蕊 累(~積) 纍{累}(罪惡~~)   ⑤ lûi 雷 鐳{镭} 蕾 擂 羸   ⑥ lũi 淚{泪} 累(勞~,拖~)   ⑦ lūi 類{类}  |
...
|g| ⑦ gāi 礙{碍}  |
|ng| ⑤ ngâi 皚{皑} 呆 崖 涯 捱{挨}(~苦)   ⑥ ngãi 艾 岸  |
...
| | ① uai 挖 歪  |
|s| ① suai 甩  |
|k| ① kuai 乖 鮭{鲑}   ② kuái 拐(~騙) 柺{拐}(老人~)   ③ kuài 怪 劊{刽} 會{会} 繪{绘} 儈{侩} 檜{桧} 膾{脍}  |
|kh| ③ khuài 筷 快  |
...
|k| ① kou 辜 菇 估 沽 孤 姑 枯   ② kóu 苟 估 鼓 古 股 嘏 牯   ③ kòu 妒 垢 構{构} 購{购} 夠{够} 顧{顾} 僱{雇}   ⑤ kôu 糊(麵線~) 餬{糊}(麵線~)   ⑥ kõu 靠  |
...
|p| ② piáu 殍 表(~示)  |
|ph| ① phiau 標{标} 膘 飄{飘} 漂 瓢 飆{飙} 驃{骠}  |
|m| ② miáu 藐 秒 杳 渺(~茫) 淼(煙波浩~)   ⑤ miâu 錨{锚} 苗 描 瞄   ⑥ miãu 妙  |
|t| ① tiau 碉 叼 凋 刁 貂   ③ tiàu 吊(~燈) 弔{吊}(憑~)   ⑤ tiâu 條{条}   ⑥ tiãu 兆 召   ⑦ tiāu 掉 調{调}  |
|th| ① thiau 挑 迢   ② thiáu 眺 窕   ③ thiàu 超 跳   ⑤ thiâu 調{调}   ⑥ thiãu 柱  |
|n| ② niáu 溺 嫋{袅}   ③ niàu 皺{皱}  |
|l| ② liáu 了(~斷) 瞭{了}(明~,~解)   ③ liàu 了(到~)   ⑤ liâu 撈{捞} 撩 聊 僚 療{疗} 燎 寥 遼{辽} 潦 鐐{镣} 獠 醪 瞭{了}(~望)   ⑦ liāu 廖 料  |
...
|k| ① kuaⁿ 竿 肝 稈{秆} 棺 官 桿{杆}(桿菌,筆桿)   ② kuáⁿ 趕{赶} 果   ⑤ kuâⁿ 寒   ⑦ kuāⁿ 汗  |
|kh| ① khuaⁿ 款  |
...
|tsh| ① tshoiⁿ 仟 千(~萬)   ② tshóiⁿ 筅   ⑤ tshôiⁿ 蠶{蚕}  |
|s| ① soiⁿ 嘶 先  |
...
|ts| ③ tsàn 攢{攒} 棧{栈} 鑽{钻} 贊{赞}(點~,~同) 讚{赞}(~嘆)   ⑤ tsân 層{层}   ⑧ tsa̍t 實{实}  |
...
| |in / it|
|-|----|
| | ① in 煙{烟} 茵 因 姻 甄 胭 咽(~喉)   ② ín 引 隱{隐} 蚓   ③ ìn 印 應{应}   ④ it 噎 一 乙 咽(哽~)   ⑤ în 鉛{铅} 沿 演 寅   ⑦ īn 暈{晕}   ⑧ i̍t 逸 佚 軼{轶}  |
|p| ① pin 彬 斌 濱{滨} 賓{宾}   ② pín 品 匾   ③ pìn 遍 擯{摈} 髕{髌} 鬢{鬓}   ④ pit 筆{笔} 必   ⑧ pi̍t 畢{毕} 癟{瘪}  |
|ph| ② phín 貶{贬}   ④ phit 匹(~配) 疋(布~)   ⑤ phîn 瀕{濒} 頻{频} 貧{贫}  |
|b| ⑧ bi̍t 蜜  |
|m| ② mín 甭 免   ⑤ mîn 氓 眠 民 抿 泯   ⑦ mīn 面(~子)   ⑧ mi̍t 覓{觅} 蜜 密 冪{幂} 滅{灭} 默 蔑(輕~) 衊{蔑}(污~)  |
...
|ts| ① tsun 尊 遵   ② tsún 准(~許) 準{准}(標~,~備)   ③ tsùn 峻 俊 竣 浚 駿{骏}   ④ tsut 率 摔 帥{帅} 卒   ⑤ tsûn 船 陣{阵}   ⑧ tsu̍t 糯  |
...
|kh| ① khun 坤 昆(~蟲) 崑{昆}(~崙)   ② khún 窘 菌 墾{垦} 懇{恳} 捆   ③ khùn 困(~難) 睏{困}(早~)   ④ khut 倔 窟 屈   ⑤ khûn 拳 羣{群}  |
|h| ① hun 芬 酚 吩 氛 分 紛{纷} 汾 葷{荤} 昏 婚 渾{浑} 燻{熏} 暈{晕} 薰   ② hún 粉 忿   ③ hùn 奮{奋} 憤{愤} 訓{训}   ④ hut 沸 拂 氟 弗 忽 彿{佛}(彷~)   ⑤ hûn 痕 魂 雲{云}(~雨)   ⑥ hũn 渾{浑} 混   ⑦ hūn 分 份   ⑧ hu̍t 核 佛(~經)  |
...
| |ian / iat|
|-|----|
| | ① ian 蔫 焉 淵{渊} 嫣 鳶{鸢}   ② ián 遠{远}   ③ iàn 燕 嚥{咽}(吞~)   ⑤ iân 紈{纨}   ⑥ iãn 涎 羨{羡} 蜒 延 衍 援 筵 胤   ⑦ iān 焉  |
|p| ① pian 鞭 邊{边}   ② pián 貶{贬} 扁 匾   ③ piàn 變{变} 遍   ⑥ piãn 瓣 便 卞 辨 辯{辩}   ⑧ pia̍t 蹩 別{别}(分~)  |
...
|l| ② lián 臉{脸}   ⑤ liân 聯{联} 蓮{莲} 連{连} 憐{怜} 漣{涟} 鏈{链}   ⑥ liãn 吝   ⑦ liān 鏈{链} 煉{炼} 練{练}   ⑧ lia̍t 列 烈 鬣  |
|ch| ① chian 箋{笺} 煎 濺{溅} 羶{膻}   ② chián 趁 踐{践} 餞{饯} 濺{溅} 燼{烬} 疹 診{诊} 殄 畛 翦   ③ chiàn 顫{颤} 剪 戰{战}   ④ chiat 即 浙  |
|chh| ① chhian 扦 釺{钎} 遷{迁} 纖{纤} 阡 韆{千}(鞦~)   ② chhián 淺{浅}   ④ chhiat 沏 切 竊{窃}  |
|s| ① sian 仙 秈{籼}   ② sián 銑{铣} 洗 鮮{鲜} 癬{癣} 蘚{藓} 跣   ③ siàn 煽(~風點火) 搧(~面龐)   ④ siat 契 設{设} 楔 屑 褻{亵}   ⑤ siân 闡{阐} 單{单}   ⑥ siãn 單{单} 擅 膳 善 繕{缮} 腎{肾} 鱔{鳝} 撣{掸}(~族)  |
|j| ⑤ jiân 然 燃   ⑧ jia̍t 熱{热}  |
|k| ① kian 堅{坚} 捐 鵑{鹃} 娟   ③ kiàn 見{见} 建 絹{绢}   ④ kiat 吉 潔{洁}   ⑥ kiãn 鍵{键} 健 建 毽 犍   ⑧ kia̍t 傑{杰} 竭 桀  |
|kh| ① khian 虔   ② khián 遣 譴{谴} 犬   ④ khiat 撅 契 孑 挈 黠   ⑤ khiân 乾{干}(~坤)  |
...
|s| ① suan 喧 宣 萱   ② suán 選{选}   ③ suàn 氽 汆   ⑤ suân 旋(~轉,黑~風)   ⑥ suãn 旋(~尿)  |
|z| ② zuán 轉{转} 纂   ⑧ zua̍t 說{说} 悅{悦}  |
|k| ① kuan 關{关} 冠 觀{观} 綸{纶}   ② kuán 管 館{馆}   ③ kuàn 冠 觀{观} 罐 慣{惯} 灌 貫{贯} 眷 券 摜{掼} 盥   ④ kuat 抉 決{决} 訣{诀} 括 廓 炔 玦 刮 颳{刮}(~風)   ⑥ kuãn 倦 捲{卷}(~煎,席~)  |
|kh| ① khuan 寬{宽} 傾{倾} 頃{顷} 圈 髖{髋}   ② khuán 款 傾{倾} 頃{顷}   ⑤ khuân 顴{颧} 權{权}  |
|ng| ② nguán 阮 玩 頑{顽}   ⑤ nguân 顏{颜} 元 原 源   ⑥ nguãn 願{愿}(心~)  |
|h| ① huan 番 翻 歡{欢} 獾   ② huán 反 返 緩{缓}   ③ huàn 販{贩} 換{换} 喚{唤} 瘓{痪} 煥{焕} 渙{涣} 幻   ④ huat 發{发}(~現) 髮{发}(~型)   ⑤ huân 樊 繁 煩{烦} 環{环} 桓 還{还} 垣   ⑥ huãn 飯{饭} 豢 宦   ⑧ hua̍t 罰{罚} 筏 伐 乏 閥{阀} 穴  |
...
| |ang / ak|
|-|----|
| | ① ang 骯{肮} 翁   ③ àng 盎 甕{瓮}   ④ ak 沃 抑 軋{轧} 惡{恶}(罪~)   ⑤ âng 洪 紅{红}  |
|p| ① pang 邦 幫{帮} 梆 崩 繃{绷} 蹦 方 肪 楓{枫} 彭   ② páng 榜 膀 綁{绑} 耪   ③ pàng 放   ④ pak 捌 八 剝{剥} 北 膊 輻{辐} 幅 腹 亳 別{别}(~人)   ⑤ pâng 房 馮{冯}   ⑥ pãng 棒 謗{谤}   ⑧ pa̍k 縛{缚}  |
|ph| ① phang 芳 蜂 香   ② pháng 紡{纺}   ④ phak 博 搏 伏 趴   ⑤ phâng 膀 磅 傍 帆 航 龐{庞} 旁 彭 篷 彷(彷~)   ⑦ phāng 縫{缝}   ⑧ pha̍k 雹 暴 曝 瀑  |
|b| ⑧ ba̍k 墨 木  |
|m| ② máng 莽 蟒 蠓   ④ mak 衊{蔑}(~着)   ⑤ mâng 芒 茫 盲 氓 忙   ⑥ mãng 幕 網{网}   ⑦ māng 夢{梦}   ⑧ ma̍k 目  |
|t| ① tang 檔{档} 東{东} 冬 中 噹{当}(叮~)   ② táng 黨{党} 等 董   ③ tàng 擋{挡} 檔{档} 凍{冻} 當{当}(適~)   ④ tak 韃{鞑}   ⑤ tâng 銅{铜} 童 筒 仝 同(相~)   ⑥ tãng 動{动} 筒 重 宕 蕩{荡}(坦~,掃~,遊~) 盪{荡}(震~)   ⑦ tāng 洞   ⑧ ta̍k 達{达} 毒 獨{独} 度 值  |
|th| ① thang 通 蹚   ② tháng 償{偿} 倘 躺 淌 趟 桶 帑   ③ thàng 亙{亘}   ④ thak 塞 撻{挞} 踢 拓   ⑤ thâng 蟲{虫} 塘 搪 堂 棠 膛 唐 桐   ⑥ thãng 動{动}   ⑧ tha̍k 讀{读}  |
|n| ⑤ nâng 人 儂{侬}  |
|l| ② láng 囊   ④ lak 碌 落   ⑤ lâng 琅 榔 狼 廊 郎 聾{聋} 籠{笼} 膿{脓} 稂 踉   ⑥ lãng 朗 浪 卵 踉   ⑧ la̍k 樂{乐} 力 六 陸{陆} 栗(猴~) 慄{栗}  |
|ts| ① tsang 贓{赃} 曾 莊{庄} 鬃 棕 臧 髒{脏}(骯~)   ② tsáng 總{总}   ③ tsàng 壯{壮} 糉{粽}   ④ tsak 節{节} 軋{轧} 鍘{铡} 作 扎(掙~) 紮{扎}(包~,駐~)   ⑤ tsâng 叢{丛}   ⑥ tsãng 藏 臟{脏}(~器)   ⑦ tsāng 贈{赠}  |
|tsh| ① tshang 蒼{苍} 倉{仓} 滄{沧} 蔥{葱} 蹌{跄}   ③ tshàng 創{创}   ④ tshak 擦 察 錯{错} 漆 膝   ⑤ tshâng 藏 纏{缠}   ⑧ tsha̍k 鑿{凿} 賊{贼}  |
|s| ① sang 雙{双} 鬆{松}(個芋會~)   ② sáng 嗓 㾪   ③ sàng 喪{丧} 送   ④ sak 撒 薩{萨} 塞 剎{刹} 蝨{虱}  |
|k| ① kang 岡{冈} 剛{刚} 缸 肛 綱{纲} 崗{岗} 工 功 公 江 扛 蚣   ② káng 港 講{讲}   ③ kàng 贛{赣} 槓{杠} 降   ④ kak 鉻{铬} 各 角 覺{觉} 軋{轧} 穀{谷}(五~)   ⑦ kāng 共  |
|kh| ① khang 工 康 慷 糠 空 匡   ③ khàng 抗 亢 炕 吭   ④ khak 嘎 霍 殼{壳} 榷 確{确} 恪 麴{曲}(鼠~草)  |
|ng| ① ngang 昂   ⑧ nga̍k 鄂 噩 鱷{鳄} 岳(~父) 嶽{岳}(三山五~)  |
...
| |eng / ek|
|-|----|
| | ① eng 翁 英 櫻{樱} 嬰{婴} 鷹{鹰} 纓{缨} 罌{罂} 膺 鶯{莺} 鸚{鹦}   ② éng 湧{涌}(海~)   ③ èng 應{应}   ④ ek 臆 溢   ⑦ ēng 用   ⑧ e̍k 隘 掖 腋 液 易 億{亿} 疫 亦 憶{忆} 溢 譯{译} 翼 翌 繹{绎} 浴 奕 弈  |
|p| ② péng 秉 炳   ④ pek 柏 薄 逼 伯 迫   ⑤ pêng 迸   ⑥ pẽng 併{并}(合併) 並{并}(並立,並且)  |
|ph| ① pheng 烹 拼(~凑)   ③ phèng 騁{骋} 聘   ④ phek 碧 霹 劈 魄 辟(復~) 闢{辟}(開~)   ⑤ phêng 砰 抨 硼 朋 坪 萍 平 憑{凭} 評{评} 怦  |
|m| ② méng 錳{锰} 猛 皿   ⑤ mêng 盲 萌 盟 明 螟 鳴{鸣} 銘{铭} 名 冥 暝 瞑 酩   ⑥ mẽng 孟 命   ⑧ me̍k 陌 貊  |
|t| ① teng 蹬 燈{灯} 登 丁 叮 釘{钉} 酊 徵{征}(~求,~兆) 癥{症}(~結)   ② téng 等 頂{顶} 戥   ③ tèng 凳 盯 釘{钉} 訂{订} 中   ④ tek 德 嫡 竹 竺   ⑤ têng 塵{尘} 亭 重 婷   ⑥ tẽng 鄧{邓} 澱{淀} 錠{锭} 定 綻{绽} 鄭{郑}   ⑧ te̍k 的 迪 敵{敌} 笛 狄 滌{涤} 翟 鹿 特 蟄{蛰} 值 軸{轴}  |
...
|ch| ① cheng 丁 睛 精 僧 增 憎 曾 貞{贞} 偵{侦} 蒸 掙{挣} 睜{睁} 猙{狰} 怔 幀{帧} 盅 甑 箏{筝} 舂 征(~服) 鐘{钟}(~頭) 鍾{钟}(~愛)   ② chéng 種{种} 腫{肿}   ③ chèng 蹭 正 政 證{证} 種{种} 衆{众} 症(~狀)   ④ chek 叔 則{则} 燭{烛} 稷   ⑤ chêng 曾   ⑥ chẽng 靖 淨{净} 靚{靓}   ⑧ che̍k 蜀 一 壹 澤{泽}  |
|chh| ① chheng 稱{称} 清   ③ chhèng 襯{衬} 稱{称}   ④ chhek 側{侧} 測{测} 斥 僳 戚 粟 彳   ⑤ chhêng 橙 情   ⑦ chhēng 穿  |
|s| ① seng 聲{声} 生 甥 牲 勝{胜} 腥 猩 惺 旌 昇{升}(東~)   ② séng 省   ③ sèng 勝{胜} 聖{圣}   ④ sek 瑟 色 識{识} 式 適{适} 釋{释} 飾{饰} 碩{硕} 昔 析 矽 晰 息 悉 夕 熄 汐 媳 植 殖 擲{掷} 晳 皙 穡{穑} 窸 蟋   ⑤ sêng 成 乘 誠{诚} 承 丞 榕 松(~樹)   ⑥ sẽng 乘 盛   ⑧ se̍k 熟  |
|j| ⑤ jêng 扔  |
|k| ① keng 更 供 宮{宫} 弓 荊{荆} 兢 驚{惊} 經{经} 矜   ② kéng 景 境 竟   ③ kèng 更 敬 亙{亘}   ④ kek 革 激 棘 菊 檄 亟   ⑤ kêng 瓊{琼}   ⑥ kẽng 警 競{竞}   ⑧ ke̍k 極{极} 局  |
|kh| ① kheng 兢 筐 卿   ② khéng 肯 啃   ③ khèng 慶{庆} 罄   ④ khek 擊{击} 刻 蛐 曲(戲~,~折) 麴{曲}(酒~)   ⑤ khêng 莖{茎} 鯨{鲸} 痙{痉} 擎 扃  |
|g| ⑧ ge̍k 玉 獄{狱}  |
|ng| ⑤ ngêng 凝(~固) 迎   ⑧ nge̍k 逆  |
|h| ① heng 哼 亨 興{兴} 胸 匈 馨   ③ hèng 興{兴}   ④ hek 核 閡{阂} 黑   ⑤ hêng 恆{恒} 王 刑 型 形 行 雄   ⑥ hẽng 行 杏 孕 幸(~災樂禍,寵~) 倖{幸}(僥~,~存)   ⑧ he̍k 乏  |
...
|p| ④ pok 卜(~卦)   ⑤ pông 泵 乓   ⑦ pōng 磅 鎊{镑}   ⑧ po̍k 蔔{卜}(~蔔) 僕{仆}(奴~,風塵~~)  |
|ph| ② phóng 捧 搿   ③ phòng 膀 碰   ④ phok 爆 撲{扑} 仆(前~後繼) 朴(~樹) 樸{朴}(~素)   ⑤ phông 縫{缝} 蓬 篷 鵬{鹏}  |
|m| ② móng 某 晚   ③ mòng 貿{贸}   ⑤ mông 芒 檬 摸 謀{谋} 蠓 蒙(~古,啟~,~難,~娜麗莎) 濛{蒙}(~煙) 矇{蒙}(~矓,~騙) 朦(~朧)   ⑥ mõng 茂 舞   ⑧ mo̍k 沒{没} 莫 漠 寞 木 睦 牧 穆 疫 沐  |
|t| ① tong 東{东} 冬 中 忠   ② tóng 董 懂   ③ tòng 棟{栋} 凍{冻} 疼 中   ④ tok 督 築{筑}   ⑤ tông 幢   ⑥ tõng 動{动} 重 仲   ⑧ to̍k 毒 犢{犊} 獨{独} 逐 篤{笃}  |
|th| ① thong 通   ② thóng 寵{宠} 捅 統{统}   ③ thòng 痛   ④ thok 禿{秃} 亍   ⑤ thông 幢 侗 恫 洞 桐 酮 瞳 彤 童 仝 衕{同}(衚~)   ⑦ thōng 洞  |
...
|tsh| ① tshong 充 聰{聪} 蔥{葱} 囪{囱} 匆 衷 種{种} 忡 沖{冲}(~茶,相~) 衝{冲}(~擊,要~)   ③ tshòng 衝{冲}(~勁)   ④ tshok 矗 觸{触} 戳 促 捉 亍 蹴 齬{龉}   ⑤ tshông 崇 從{从} 重  |
|s| ① song 鬆{松}(輕~)   ② sóng 聳{耸} 慫{怂}   ③ sòng 宋   ④ sok 寂 叔 淑 束 數{数} 漱 速 塑 肅{肃} 縮{缩} 索 夙   ⑤ sông 嵩 松(~樹)   ⑥ sõng 頌{颂} 訟{讼} 誦{诵}   ⑧ so̍k 贖{赎} 孰 屬{属} 俗 續{续}  |
|z| ② zóng 冗   ⑤ zông 仍 戎 茸 絨{绒}   ⑧ zo̍k 辱 褥  |
|k| ① kong 工 攻 功 龔{龚} 公 蚣   ② kóng 講{讲}   ③ kòng 槓{杠} 汞 貢{贡}   ④ kok 國{国} 咯 峪 幗{帼} 谷(山~) 穀{谷}(五~)  |
|kh| ① khong 空   ② khóng 孔   ③ khòng 控   ④ khok 哭 酷 梏  |
|h| ① hong 封 峯{峰} 鋒{锋} 風{风} 烽 轟{轰} 烘 丰(~采) 豐{丰}(~盛) 哄(~堂大笑)   ② hóng 蚌 俸 哄(~騙)   ③ hòng 諷{讽} 訌{讧} 哄(~搶) 鬨{哄}(起~)   ④ hok 輻{辐} 福 複{复}(重~,~雜)   ⑤ hông 逢 縫{缝} 烘 虹 鴻{鸿} 洪 宏 弘 紅{红} 肱   ⑥ hõng 奉 鳳{凤}   ⑧ ho̍k 伏 服 袱 覆(反~,~蓋) 或 惑 域 復{复}(~仇,~復)  |
...
|th| ③ thiàng 暢{畅}  |
|n| ⑤ niâng 娘  |
|l| ② liáng 倆{俩} 兩{两} 輛{辆} 魎{魉}   ⑤ liâng 憐{怜} 涼{凉} 梁 粱 良 量   ⑥ liãng 量 晾 亮 諒{谅}   ⑧ lia̍k 撂 略 慄{栗}  |
...
|s| ① siang 墒 商 湯{汤} 相 鑲{镶} 襄 湘 殤{殇} 觴{觞}   ② siáng 想 鯗{鲞}   ③ siàng 相   ⑤ siâng 上 裳 翔 祥 詳{详} 嫦 嘗{尝}(~試)   ⑥ siãng 上 尚 像 象  |
|j| ② jiáng 釀{酿} 壤 攘 嚷   ⑤ jiâng 瓤   ⑥ jiãng 讓{让}   ⑧ jia̍k 若 弱  |
|k| ① kiang 疆 羌 僵(~硬) 殭{僵}(~屍) 姜(~子牙)   ② kiáng 強{强}  |
|kh| ③ khiàng 強{强}   ④ khiak 攫 怯 卻{却}   ⑤ khiâng 強{强} 襁  |
|ng| ② ngiáng 仰   ⑧ ngia̍k 鎳{镍} 虐 瘧{疟}  |
|h| ① hiang 香 鄉{乡}   ② hiáng 晌 響{响} 享 饗{飨}   ③ hiàng 向(方~) 嚮{向}(~往)   ④ hiak 蠍{蝎}  |

## iong / iok

| |iong / iok|
|-|----|
| | ① iong 臃 癰{痈} 雍   ② ióng 踴{踊} 蛹 永 勇   ③ iòng 擁{拥} 詠{咏} 泳 恿   ⑤ iông 蓉 榮{荣} 融 熔 溶 容 瑩{莹} 螢{萤} 熒{荧} 盈 庸 榕 縈{萦} 佣(~金) 傭{佣}(~人)   ⑧ io̍k 峪 育 浴 欲(暢所~言,搖搖~墜) 慾{欲}(~望)  |
|th| ④ thiok 蓄 畜  |
|k| ① kiong 恭 躬 共 穹   ② kióng 拱   ④ kiok 鞠 粥  |
|kh| ② khióng 鞏{巩} 恐   ④ khiok 可 克(~服,千~) 剋{克}(~扣,相~)   ⑤ khiông 窮{穷}  |
|h| ① hiong 匈 洶{汹} 凶(~惡,~~) 兇{凶}(~手)   ④ hiok 旭 毓 馥 郁(文采~~,~達夫)   ⑤ hiông 雄  |

## uang / uak

| |uang / uak|
|-|----|
| | ① uang 汪   ② uáng 枉 往   ⑤ uâng 蝗 皇 凰 王   ⑥ uãng 王 旺   ⑧ ua̍k 獲{获}(~得,不勞而~) 穫{获}(收~)  |
|ph| ④ phuak 般 撥{拨}  |
...
|h| ① huang 坊 芳 方 肪 封 風{风} 瘋{疯} 荒 慌 謊{谎}   ② huáng 坊 訪{访} 紡{纺} 晃 幌 恍 仿(模~) 彷(~彿)   ③ huàng 放   ⑤ huâng 防 妨 衡 磺 蝗 簧 皇 凰 惶 煌 徨  |
...
|t| ① tng 當{当}(~家)   ② tńg 轉{转}   ③ tǹg 擋{挡} 頓{顿} 當{当}(安步~車)   ⑤ tn̂g 長{长} 腸{肠} 塘 堂 唐   ⑥ tñg 斷{断} 丈   ⑦ tn̄g 傳{传} 段 緞{缎}  |
...
|k| ① kng 缸 崗{岗} 光 扛   ② kńg 耿 管 廣{广} 卷(試~)   ③ kǹg 鋼{钢}  |
|kh| ① khng 糠   ③ khǹg 勸{劝}  |
