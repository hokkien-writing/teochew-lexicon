...
|ts| ① tsang 贓{赃} 曾 莊{庄} 鬃 棕 臧 髒{脏}(骯~)   ② tsáng 總{总}   ③ tsàng 壯{壮} 糉{粽}   ④ tsak 軋{轧} 鍘{铡} 作 扎{扎}(掙~) 紮{扎}(包~,駐~)   ⑤ tsâng 叢{丛}   ⑥ tsãng 藏 臟{脏}(~器)   ⑦ tsāng 贈{赠}  |
...
|s| ① siang 墒 商 湯{汤} 相 鑲{镶} 襄 湘 殤{殇} 觴{觞}   ② siáng 想 鯗{鲞}   ③ siàng 相   ④ siak 屑   ⑤ siâng 上 裳 翔 祥 詳{详} 嫦 嘗{尝}(~試)   ⑥ siãng 上 尚 像 象  |
